...
int main(void)
{
    ...
    strcpy(source_ip, "10.100.17.200");
    sin.sin_family = AF_INET;
    sin.sin_port = htons(4048);
    sin.sin_addr.s_addr = inet_addr("130.208.249.246");
    ...
    udph->uh_dport = htons(4048);  // Destination port
